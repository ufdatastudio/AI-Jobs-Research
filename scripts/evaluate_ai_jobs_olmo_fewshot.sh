...
#SBATCH --job-name ai-jobs-olmo-few
#SBATCH --output=batch_scripts/ai_jobs_olmo_few_%j.out
#SBATCH --error=batch_scripts/ai_jobs_olmo_few_%j.err
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --time=2:30:00
#SBATCH --mem=48GB
...
OUTPUT_DIR="${BASE_DIR}/results/JobPostings/OLMo_FewShot"
...
python models/evaluate_jobs_olmo.py \
  --csv_path "${CSV_PATH}" \
