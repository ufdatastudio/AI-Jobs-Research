...
#SBATCH --job-name ai-jobs-gemma-few
#SBATCH --output=batch_scripts/ai_jobs_gemma_few_%j.out
#SBATCH --error=batch_scripts/ai_jobs_gemma_few_%j.err
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --time=3:00:00
#SBATCH --mem=64GB
...
OUTPUT_DIR="${BASE_DIR}/results/JobPostings/Gemma_FewShot"
