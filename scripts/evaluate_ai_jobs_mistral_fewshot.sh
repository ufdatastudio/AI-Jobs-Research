...
#SBATCH --job-name ai-jobs-mistral-few
#SBATCH --output=batch_scripts/ai_jobs_mistral_few_%j.out
#SBATCH --error=batch_scripts/ai_jobs_mistral_few_%j.err
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --time=2:30:00
#SBATCH --mem=48GB
...
OUTPUT_DIR="${BASE_DIR}/results/JobPostings/Mistral_FewShot"
